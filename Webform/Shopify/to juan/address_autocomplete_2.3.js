(function(window){
    ...
    function removeMaxLengthMessage(){
        var maxLengthMessage = document.getElementById("maxLength");
        if (maxLengthMessage){
            maxLengthMessage.parentNode.removeChild(maxLengthMessage);
        }
    }
    function validateMaxLength(e) {
        removeMaxLengthMessage();
